...
public class JwtService {
    ...
    /**
     * Valida que el secreto sea válido en Base64 y tenga longitud mínima recomendada (256 bits)
     */
    @PostConstruct
    public void validateSecretKey() {
        try {
            ...
            throw new IllegalStateException("Configuración inválida: jwt.secret no es válido", ex);
        }
    }
    ...
    /**
     * Construye el token con los parámetros especificados
     */
    ...
    /**
     * Obtiene la clave de firma como SecretKey usando Base64 decoding
     */
